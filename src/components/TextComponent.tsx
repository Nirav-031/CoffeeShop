...
// import {fontSizes, getFontSize} from '@/utils/deviceUtils';
// import {font} from '@/utils/GlobalStyle';
import { FONTFAMILY } from '@utils/GlobalStyle';
...
const styles = StyleSheet.create({
  text: {
    fontFamily:FONTFAMILY.poppins_regular,
    // Reset all possible spacing properties
    margin: 0,
    marginTop: 0,
    marginRight: 0,
    marginBottom: 0,
    ...
    letterSpacing: 0,
    // Other potential spacing properties
    includeFontPadding: false,
    // Android specific
    textAlignVertical: 'center',
    // Android specific // Ensure height is determined only by content
    height: undefined,
    minHeight: undefined,
  } as TextStyle,
});
